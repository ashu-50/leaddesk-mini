  ...
  'mb-2 flex shrink-0 items-center justify-center [&_svg:not([class*=size-])]:size-6',
  {
    variants: {
      variant: {
        ...
        icon: 'flex size-11 items-center justify-center rounded-lg bg-muted text-muted-foreground',
      },
    },
...
function EmptyContent({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('flex w-full max-w-sm flex-col items-center gap-3 text-sm text-balance', className)}
      {...props}
    />
  );
}
